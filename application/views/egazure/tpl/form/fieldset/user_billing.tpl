...
[{/if}]
   ...
   <li [{if $aErrors.oxuser__oxstreet}]class="oxInValid"[{/if}]>
        <label [{if $oView->isFieldRequired(oxuser__oxstreet)}]class="req"[{/if}]>[{ oxmultilang ident="FORM_FIELDSET_USER_BILLING_STREET" }]</label>
...
<!--         <input [{if $oView->isFieldRequired(oxuser__oxstreetnr) }]class="js-oxValidate js-oxValidate_notEmpty" [{/if}]type="text"        data-fieldsize="xsmall" maxlength="16" name="invadr[oxuser__oxstreetnr]" value="[{if isset( $invadr.oxuser__oxstreetnr ) }][{ $invadr.oxuser__oxstreetnr }][{else }][{ $oxcmp_user->oxuser__oxstreetnr->value }][{/if}]">   -->
    ...
    <li [{if $aErrors.oxuser__oxcity}]class="oxInValid"[{/if}]>
      <label [{if $oView->isFieldRequired(oxuser__oxcity)}]class="req"[{/if}]>[{ oxmultilang ident="FORM_FIELDSET_USER_BILLING_CITY" }]</label> 
          <input [{if $oView->isFieldRequired(oxuser__oxcity) }]class="js-oxValidate js-oxValidate_notEmpty" [{/if}]type="text" size="37" maxlength="255" name="invadr[oxuser__oxcity]" value="[{if isset( $invadr.oxuser__oxcity ) }][{ $invadr.oxuser__oxcity }][{else }][{ $oxcmp_user->oxuser__oxcity->value }][{/if}]">
    ...
    <li [{if $aErrors.oxuser__oxzip}]class="oxInValid"[{/if}]>
        <label [{if $oView->isFieldRequired(oxuser__oxzip)}]class="req"[{/if}]>[{ oxmultilang ident="FORM_FIELDSET_USER_BILLING_POSTALCODE" }]</label>
          <input [{if $oView->isFieldRequired(oxuser__oxzip) }]class="js-oxValidate js-oxValidate_notEmpty" [{/if}]type="text" data-fieldsize="pair-small" maxlength="16" name="invadr[oxuser__oxzip]" value="[{if isset( $invadr.oxuser__oxzip ) }][{ $invadr.oxuser__oxzip }][{else }][{ $oxcmp_user->oxuser__oxzip->value }][{/if}]"> 
